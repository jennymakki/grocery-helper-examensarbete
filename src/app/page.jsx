  ...
  if (status === "loading") {
    return (
      <section className="hero-premium">
        <LoadingSkeleton width="60%" height="3rem" style={{ marginBottom: "1rem" }} />
        <LoadingSkeleton width="80%" height="1.2rem" style={{ marginBottom: "0.5rem" }} />
        <LoadingSkeleton width="40%" height="2.5rem" style={{ marginTop: "1rem" }} />
      </section>
    );
  }
